    ...
    public class LibraryRepository : ILibraryRepository
    {
        ...
        public PagedList<Author> GetAuthors(AuthorsResourceParameters authorsResourceParameters)
        {
            ...
            var collectionBeforePaging = _context.Authors.ApplySort(authorsResourceParameters.OrderBy,
                _propertyMappingService.GetPropertyMapping<AuthorsDto,Author>());
            ...
            //    .ToList();//paging po sortowaniu dzieki temu orderby zadziala na calej kolekcji a nie na jednej stronie
        }
